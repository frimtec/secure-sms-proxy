...
final class SecureSmsProxyFacadeImpl implements SecureSmsProxyFacade {
  ...
  public Installation getInstallation() {
    ...
    String apiVersion = DEV_VERSION.equals(BuildConfig.VERSION_NAME) ? DEV_VERSION  : new Semver(BuildConfig.VERSION_NAME).withClearedSuffixAndBuild().getValue();
  ...
  static AppCompatibility detectCompatibility(@NonNull String apiVersion, @NonNull String appVersion) {
    ...
    if (appSemVersion.isLowerThanOrEqualTo(MIN_SUPPORTED_VERSION)) {
      ...
      return new Semver(apiVersion).withClearedSuffixAndBuild().isGreaterThan(appSemVersion) ? AppCompatibility.UPDATE_RECOMMENDED : AppCompatibility.SUPPORTED;
    }
  }
