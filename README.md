...
```
dependencies {
    implementation 'com.github.frimtec:secure-sms-proxy-api:2.1.6'
}
```
...
The current Android target SDK is 32 (Android 13) and the minimal SDK is 24 (Android 7.0-Nougat).
