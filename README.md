...
```
dependencies {
    implementation 'com.github.frimtec:secure-sms-proxy-api:3.7.1@aar'
...
The current Android target SDK is 37 (Android 17-Cinnamon Bun) and the minimal SDK is 24 (Android 7.0-Nougat).
