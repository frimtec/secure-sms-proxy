...
```
dependencies {
    implementation 'com.github.frimtec:secure-sms-proxy-api:2.0.4'
}
```
...
## Development
S2MSP is developed with [Android-Studio 2020.3.1](https://developer.android.com/studio) with Java 11.
